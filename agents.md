...
Preserve published history: avoid git rebase in favor of git merge.
...
3. Review linked pull requests, issues, Linear work, related repositories in `3FA-app`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
