...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`3FA-app`](https://github.com/3FA-app) GitHub owner.

Planning and delivery context is tracked in [github.com/3FA-app](https://linear.app/denman/project/githubcom3fa-app-c3db52220894). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/3FA-app/.github).
